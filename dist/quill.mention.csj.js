...
function (_Embed) {
  ...
  _createClass(MentionBlot, null, [{
    ...
    value: function create(data) {
      var denotationChar = document.createElement("a");
      denotationChar.innerText = data.value;
      denotationChar.dataset["mention"] = "".concat(data.id);
...
function () {
  ...
  _createClass(Mention, [{
    ...
    value: function setMentionContainerPosition() {
      ...
      if (topPos >= 0) {
        this.mentionContainer.classList.add("".concat(this.options.mentionContainerClass, "-bottom"));
        this.mentionContainer.classList.remove("".concat(this.options.mentionContainerClass, "-top"));
      } else {
        this.mentionContainer.classList.add("".concat(this.options.mentionContainerClass, "-top"));
        this.mentionContainer.classList.remove("".concat(this.options.mentionContainerClass, "-bottom"));
      }
